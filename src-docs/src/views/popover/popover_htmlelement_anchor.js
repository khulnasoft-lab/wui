...
import { WuiWrappingPopover } from '../../../../src/components';
  ...
  return (
    <div
      dangerouslySetInnerHTML={{
        __html: `
  <button id="popoverAnchorButton" class="wuiButton wuiButton--primary">
    <span class="wuiButton__content">This is an HTML button</span>
  </button>
        `,
      }}
    />
