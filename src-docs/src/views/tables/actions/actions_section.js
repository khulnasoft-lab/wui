...
import { WuiBasicTable } from '../../../../../src/components';
  ...
  text: (
    <div>
      <p>
        ...
        most basic action you might define is a type <WuiCode>button</WuiCode>{' '}
        or <WuiCode>icon</WuiCode> though you can always make your own custom
        actions as well.
      </p>
      ...
      <ul>
        <li>
          ...
          actions are defined, the first 2 <WuiCode>isPrimary</WuiCode> actions
