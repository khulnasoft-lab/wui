...
function compileLib() {
  ...
  // validate the generated wui.d.ts doesn't contain errors
...
function compileBundle() {
  ...
  execSync(
    'webpack src/themes/charts/themes.ts -o dist/wui_charts_theme.js --output-library-target="commonjs" --config=src/webpack.config.js',
    {
      stdio: 'inherit',
    }
  );
  dtsGenerator({
    prefix: '',
    out: 'dist/wui_charts_theme.d.ts',
